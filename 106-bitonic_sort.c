 ...
 * @start: To start an index of the sequence in array to sort.
 ...
 * @array: The array of an integers.
 * @size: The size of the array.
 * @start: Tostart an index of a block of the building bitonic sequence.
 ...
 * @size: The size of the array.
 *
 * Description: To print the array after each swap. Only works for
